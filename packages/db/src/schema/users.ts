...
// Better Auth manages this table — we define it here so Drizzle can generate migrations
// and so we can reference it in queries. Better Auth's admin plugin adds role/banned columns.
...
export const sessions = pgTable("session", {
  ...
  // Better Auth admin plugin adds impersonated-by tracking
